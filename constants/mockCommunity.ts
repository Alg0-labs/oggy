...
export const communityApps: CommunityApp[] = [
  ...
  // ── Trending ────────────────────────────────────────────────────────────────
  {
    id: "c_035",
    name: "AI Horoscope",
    prompt: "Daily horoscope generator with personalized AI twist based on your mood.",
    author: communityAuthors.maya,
    modelUsed: "openai",
  ...
  },
  {
    id: "c_036",
    name: "Vibe Check",
    prompt: "Rate your vibe 1–10 and get an AI-generated pep talk or reality check.",
    author: communityAuthors.sasha,
    modelUsed: "google",
    createdDate: "2026-04-11T14:00:00Z",
    likes: 2788,
    remixes: 389,
    category: "Trending",
    imageUrl: GIF("3ohhwzHjHNlUPcMoxO"),
  ...
  },
  {
    ...
    prompt: "Spin for a random recipe using only ingredients you already have at home.",
    author: communityAuthors.rio,
    modelUsed: "anthropic",
    createdDate: "2026-04-10T11:30:00Z",
    likes: 2155,
    remixes: 302,
    category: "Trending",
    imageUrl: GIF("d1E1kn1YBe3BW"),
  ...
  },
  {
    id: "c_038",
    name: "Name That Tune",
    prompt: "Hum or whistle a melody and get an AI guess of the song.",
    author: communityAuthors.nova,
    modelUsed: "openai",
  ...
  // ── Utilities ───────────────────────────────────────────────────────────────
  {
    id: "c_039",
    name: "Unit Converter",
    prompt: "Instant unit converter for length, weight, temperature and currency.",
    author: communityAuthors.jordan,
    modelUsed: "google",
    createdDate: "2026-04-08T10:00:00Z",
    likes: 876,
    remixes: 112,
    category: "Utilities",
    imageUrl: GIF("077i6AULCXc0FKTj9v"),
  ...
  },
  {
    id: "c_040",
    name: "QR Studio",
    prompt: "Generate styled QR codes with logo overlays and colour themes.",
    author: communityAuthors.leo,
    modelUsed: "anthropic",
    createdDate: "2026-04-06T12:00:00Z",
    likes: 1102,
    remixes: 178,
    category: "Utilities",
    imageUrl: GIF("l4FGGafcOHmrlQxG0"),
  ...
  },
  {
    id: "c_041",
    name: "Password Vault",
    prompt: "Local password generator and strength checker — no cloud, no tracking.",
    author: communityAuthors.sasha,
    modelUsed: "openai",
    createdDate: "2026-04-04T09:00:00Z",
    likes: 743,
    remixes: 88,
    category: "Utilities",
    imageUrl: GIF("13HgwGsXF0aiGY"),
  ...
  },
  {
    id: "c_042",
    name: "Noise Meter",
    prompt: "Real-time decibel meter with peak hold and a colour-coded gauge.",
    author: communityAuthors.maya,
    modelUsed: "google",
    createdDate: "2026-04-02T16:00:00Z",
    likes: 519,
    remixes: 64,
    category: "Utilities",
    imageUrl: GIF("xT0xeJpnrWC4XWblEk"),
  ...
  // ── Social ──────────────────────────────────────────────────────────────────
  {
    id: "c_043",
    name: "Icebreaker",
    prompt: "Random icebreaker question generator for meetings, dates or parties.",
    author: communityAuthors.rio,
    modelUsed: "anthropic",
  ...
  },
  {
    id: "c_044",
    name: "Poll Party",
    prompt: "Create shareable instant polls with live result animations.",
    author: communityAuthors.nova,
    modelUsed: "openai",
    createdDate: "2026-04-05T15:00:00Z",
    likes: 987,
    remixes: 154,
    category: "Social",
    imageUrl: GIF("5GoVLqeAOo6PK"),
  ...
  },
  {
    id: "c_045",
    name: "Caption Gen",
    prompt: "Generate five Instagram caption options for any photo vibe or keyword.",
    author: communityAuthors.jordan,
    modelUsed: "google",
    createdDate: "2026-04-03T10:00:00Z",
    likes: 1654,
    remixes: 289,
    category: "Social",
    imageUrl: GIF("3ohhwFBwIjxVFJhKLm"),
  ...
  },
  {
    id: "c_046",
    name: "Roast Me",
    prompt: "Upload a selfie description and get a light-hearted AI roast.",
    author: communityAuthors.leo,
    modelUsed: "anthropic",
    createdDate: "2026-04-01T17:00:00Z",
    likes: 2312,
    remixes: 401,
    category: "Social",
    imageUrl: GIF("l0HlBO7eyXzIpqAsM"),
  ...
  // ── Music ───────────────────────────────────────────────────────────────────
  {
    id: "c_047",
    name: "Beat Box",
    prompt: "Tap pads to build a live drum beat — 4 tracks, 16 steps per loop.",
    author: communityAuthors.sasha,
    modelUsed: "openai",
    createdDate: "2026-04-06T14:00:00Z",
    likes: 1876,
    remixes: 334,
    category: "Music",
    featured: true,
  ...
  },
  {
    id: "c_048",
    name: "Chord Finder",
    prompt: "Tap a key and a mood to get matching chord progressions with diagrams.",
    author: communityAuthors.maya,
    modelUsed: "google",
  ...
  },
  {
    id: "c_049",
    name: "Lyrics Pad",
    prompt: "Rhyme-assisted lyric writing pad with syllable counter and beat grid.",
    author: communityAuthors.rio,
    modelUsed: "anthropic",
  ...
  },
  {
    id: "c_050",
    name: "Metronome+",
    prompt: "Visual metronome with tap-tempo, subdivisions and accent pattern editor.",
    author: communityAuthors.nova,
    modelUsed: "openai",
    createdDate: "2026-03-31T09:00:00Z",
    likes: 641,
    remixes: 89,
    category: "Music",
    imageUrl: GIF("077i6AULCXc0FKTj9v"),
